...
/**
 * Strings for component 'local_obf', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   local_obf
...
$string['apidataretrieve'] = 'Recuperar eventos';
$string['apidataretrieveall'] = 'Todo/a(s)';
...
$string['apidataretrievelocal'] = 'Eventos originados desde este sistema';
...
$string['backpackconfig'] = 'Configuraciones de mochila';
...
$string['backpacksettings'] = 'Configuración de mochila';
...
$string['personalbadgecloudservices'] = 'Nubve de Insignias';
...
$string['profilebadgelistmoz'] = 'Insignias de mochila';
...
$string['showconnectionconfig'] = 'Yo sé que está funcionando, pero déjame cambiar la ficha (token) de cualquier forma.';
...
$string['verifytoken'] = 'Ficha (token)';
