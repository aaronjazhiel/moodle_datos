...
/**
 * Strings for component 'enrol_stripepayment', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['customwelcomemessage_help'] = 'Si Usted ingresa aquí un texto, se mostrará en lugar del texto estándar de "Este curso requiere un pago para entrar." en la página de opciones de Inscripción que los estudiantes ven cuando intentan acceder a un curso en el que no están inscritos. Si Usted deja ésto vacío, se usará el texto estándar.';
...
$string['stripepayment:unenrol'] = 'Des-inscribir stripepayment';
$string['stripepayment:unenrolself'] = 'Des-inscrirse a sí mismo en stripepayment';
