...
/**
 * Strings for component 'theme_aardvark', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['brandlogo'] = 'Logo de \'Marca\' en Barra-de-Navegación';
$string['brandlogodesc'] = 'Esta configuración le permite añadir un pequeño logo de su \'marca\' en la parte superior de la Barra de Navegación. Idealmente, el logo no deberá de ser mayor de 36 pixeles por 36 pixeles.';
...
$string['configtitle'] = 'Oso hormiguero (aardvark)';
...
$string['shortnamedesc'] = 'Mostrar el nombre corto del sitio en la barra del menú.';
