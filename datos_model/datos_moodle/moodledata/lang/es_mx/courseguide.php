...
/**
 * Strings for component 'courseguide', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   courseguide
...
$string['mustaddguide'] = 'Haga click en "Editar guía" para seleccionar una plantila y crear la guía.';
$string['name'] = 'Nombre';
...
<pre><i>La línea siguiente es un remplazable de gestor de archivos. Será remplazada por un gestor de archivos de Moodle en la página para "Añadir/Editar guía":</i></pre>
<p>[3:files]</p>
<br/>
<p>Sugerencias generales para estudiar:</p>
<pre><i>La línea siguiente es un remplazable de enlace con un nombre del enlace pre-llenado.Será remplazado por dos campos de texto (URL y nombre del enlace) en la página para "Añadir/Editar guía":</i> </pre>
<p>[4:link]</p>
<br/>
<pre><i>La línea siguiente es un remplazable de enlace con un nombre del enlace pre-llenado (solamente se mostrará texto, el HTML será ignorado):</i> </pre>
<p>[5:link:BEGIN]<br/>Haga click aquí para acceder a la página web propia del profesor<br/>[5:link:END]</p>
