...
/**
 * Strings for component 'taskchain', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   taskchain
...
: Si un archivo es seleccionado, entonces es tratado, ya sea como un **archivo de tarea (task file)** al principio de una cadena de tareas, o como un **archivo de cadena (chain file)** que contiene una lista de archivos a ser añadidos. Si no se selecciona ningun archivo, todos los archivos reconocibles en la carpeta serán añadidos como tareas.
...
$string['completedalltasks_close'] = 'Si Usted quiere terminar y cerrar este intento, haga click en el botón inferior.<br />Tome nota de que Usted no podrá re-hacer tareas en este intento después de que haya sido cerrado.';
...
Tome nota de que los reesultados de la tarea siempre son regresados a Moodle inmediatamente cuando la tarea es completada o abandonada, sin importar esta configuración.';
...
Tome nota de que si un intento fuera continuado, el cronómetro de tiempo continúa desde el momento en el que el intento fue pausado anteriormente.';
