...
/**
 * Strings for component 'tool_messageinbound', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['messageprocessingfailedunknown'] = 'Moodle no pudo procesar el Email que Usted envió con asunto "{$a->subject}". Contacte con su administrador del sistema para más información.';
