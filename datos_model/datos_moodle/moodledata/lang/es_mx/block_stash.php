...
/**
 * Strings for component 'block_stash', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   block_stash
...
$string['edittrade'] = 'Editar chunche (widget) para intercambiar \'{$a}\\';
...
$string['thetradehasbeendeleted'] = 'El chunche (widget) para intercambiar \'{$a}\' ha sido eliminado';
...
$string['tradelist'] = 'Lista de chunches (widgets) para intercambiar';
$string['tradename'] = 'Nombre del intercambio';
$string['tradename_help'] = 'El nombre del chunche (widget) de intercambio, que será mostrado a los estudiantes.';
$string['tradewidget'] = 'Creando un intercambio';
$string['tradewidget_help'] = '<p>Este chunche (widget) para intercambiar le permite ganar ítems de la columna izquierda a cambio de perder ítems de la columna derecha .</p><p>Haga click en el símbolo + en el fondo de la caja para añadir ítems a esa columna.</p><p>La cantidad de un ítem debe de ser un número positivo.</p>';
...
$string['whatisatradedrophelp'] = 'Una localización es un lugar en donde Usted intenta mostrar su chunche (widget) para intercambiar.';
