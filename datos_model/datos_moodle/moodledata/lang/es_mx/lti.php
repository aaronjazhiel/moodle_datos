...
/**
 * Strings for component 'lti', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   lti
...
$string['basiclti_endpoint'] = 'Punto-final de LTI Launch';
...
$string['click_to_continue'] = '<a href="{$a->link}" target="_top">Haga click para continuar</a>';
...
$string['editdescription'] = 'Haga click aquí para darle una descripción a esta herramienta';
...
$string['external_tool_type_help'] = 'El principal propósito de una configuración de herramienta es establecer un canal de comunicación seguro entre Moodle y el proveedor de la herramienta.
Tambien proporciona una oportunidad para poner configuraciones por defecto e instalar servicios adicionales proporcionados por la herramienta.

* **Automático, basada en Launch URL** - Esta configuración debería emplearse en casi todos los casos. Moodle eligirá la configuración de herramienta más apropiada basada en Launch URL. Se usarán herramientas configuradas tanto por el administrador o dentro del curso.
Cuando se especifica Launch URL, Moodle dará retroalimentación si es que la reconoce o no. Si Moodle no reconociera Launch URL, Usted necesitaría poner los detalles de configuración de la herramienta manualmente.
...
$string['launch_url'] = 'URl de Invocación/cartucho';
$string['launch_url_help'] = 'La URL de invocación (Launch URL) indica la dirección de internet de la herramienta externa, y puede contener información adicional, como los recursos a mostrar. Si Usted no está seguro de qué introducir para URL de invocación , por favor revise con el provedor de la herramienta para obtener mayor información.
...
Si ha elegido una herramienta preconfigurada, tal vez no necesite ingresar una URL de invocación (Launch URL). Si el enlace a la herramienta solamente se emplea para invocar el sistema del provedor de la herramienta, y no va hacia un recurso específico, este muy probablemente sea el caso.';
...
$string['notypes'] = 'Actualmente no hay herramientas configuradas para LTI (Learning Tools Interoperability = Interoperatividad de Herramientas de Aprendizaje) en Moodle. Haga click sobre el enlace para instalar (arriba) para añadirlas.';
...
$string['secure_launch_url_help'] = 'Similar a la URL de invocación (Launch URL), pero se usa en lugar de este si se requiere alta seguridad. Moodle usará el Secure Launch URL en lugar del Launch URL si el sitio Moodle es accesado mediante SSL, o si la configuración de la herramienta está definida para que siempre invoque mediante SSL.
LA URL de invocación (Launch URL) también puede configurarse hacia una dirección https para forzar a que se invoque mediante SSL, y este campo puede dejarse en blanco.';
$string['send'] = 'Enviar';
...
$string['show_in_course_lti1_help'] = 'Esta herramienta puede mostrarse en el selector de actividades para que un profesor seleccione el añadirla a un curso. También puede mostrarse en el menú desplegable de herramienta pre-configurada al añadirle una herramienta externa al curso. Una opción adicional es que la configuración de la herramienta solamente se use si se ingresa la Launch URL exacta al añadirle una herramienta externa a un curso.';
$string['show_in_course_lti2'] = 'Uso de configuración de herramienta';
$string['show_in_course_lti2_help'] = 'Esta herramienta puede mostrarse en el selector de actividades para que un profesor la seleccione para añadirla  a un curso o en el menú desplegable de herramienta pre-configurada cuando se le añade una herramienta externa a un curso.';
$string['show_in_course_no'] = 'No mostrar, usar solamente cuando se ingresa una coincidencia de Launch URL';
...
$string['toolurl'] = 'URL Base de la Herramienta/URL del cartucho';
$string['toolurl_help'] = 'La URL Base de la Herramienta se emplea para aparear las URLs para invocar herramientas con las configuraciones de Herramientas correctas. Ponerle el prefijo http(s) a la URL es opcional.

Adicionalmente, la URL base se emplea como URL para invocar (Launch URL) si es que no se especificó una URL en la instancia de la herramienta externa.
