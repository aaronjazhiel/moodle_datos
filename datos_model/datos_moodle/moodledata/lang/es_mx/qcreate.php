...
/**
 * Strings for component 'qcreate', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   qcreate
...
{$a->url}';
$string['gradecomment'] = 'Comentario a la calificación';
...
$string['questiongrade'] = 'Calificación de la pregunta';
