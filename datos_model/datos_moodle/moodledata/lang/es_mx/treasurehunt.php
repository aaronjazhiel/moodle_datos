...
/**
 * Strings for component 'treasurehunt', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['editactivity_help'] = 'Usted puede encontrar un  tutorial paso-a-paso (en idioma inglés) acerca de como crear actividades de búsqueda del tesoro en <a href="http://juacas.github.io/moodle-mod_treasurehunt/create_activity.html"> esta página.</a>';
...
<p>Para activarla, vaya en su navegador a  Configuraciones -> Configuraciones del sitio -> Localización y quite la prohibición/desalojo para este sitio.
<p>Por favor recargue esta página y conteste "SI" cuando su navegador le pregunte si desea compartir su localización.
...
Por favor contacte con su administrador si no puede solucionar este problema.';
...
TreasureHunt (Búsqueda_del_Tesoro) implementa una aplicación basada en el navegador (no es necesario instalar ninguna App nativa) y un editor geográfico para codificar las etapas del juego.
