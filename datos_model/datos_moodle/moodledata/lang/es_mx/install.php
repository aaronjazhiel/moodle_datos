...
/**
 * Strings for component 'install', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   install
...
$string['nativemariadbhelp'] = '<p>La BasedeDatos es el lugar en donde se almacenan los datos y configuraciones de Moodle y debe connfigurarse aquí.</p>
