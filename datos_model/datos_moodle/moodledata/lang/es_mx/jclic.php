...
$string['filetype_help'] = 'Esta configuración determina como es incluida la actividad JClic en el curso. Hay 2 opciones:

* JClic Subido - Habilita que un archivo válido ".jclic.zip" sea elegido mediante el selector de archivos.
* URL Externa - Permite que se especifique una URL. Nota: La URL debe empezar con http(s) o www y debe contener un archivo  "jclic.zip" o ".jclic" válido.';
...
$string['invalidurl'] = 'URL especificada inválida. Debe empezar con http(s) y debe ser un archivo ".jclic.zip" o .jclic válido.';
$string['jclic'] = 'JClic';
