...
/**
 * Strings for component 'zoom', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   zoom
...
$string['zoomerr_apiurl_error'] = 'No pudo contactarse al API de Zoom; por favor revise su bitácora de sel servidor.';
...
$string['zoomerr_meetingnotfound_info'] = 'Esta reunión ha caducado. Por favor contacte al host  de la reunión si tiene preguntas.';
