...
/**
 * Strings for component 'scheduler', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   scheduler
...
$string['groupbookings_help'] = 'Permitirles a los estudiantes reservar un lugar para todos los miembros de sus grupos. (Tome nota de que esto está separado de la configuración de "modo de grupo", la cual controla los lugares que puede ver un estudiante.)';
...
$string['maxstudentsperslot_desc'] = 'Los lugares de-grupo / lugares-no-exclusivos pueden tener como máximo este número de estudiantes. Tome nota de que, adicionalmente, siempre puede elegirse la configuración de "ilimitada" para un lugar.';
...
$string['welcomebackstudent'] = 'Usted puede reservar lugares adicionales al hacer click en el botón inferior para "Reservar lugar".';
