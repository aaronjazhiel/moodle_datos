...
/**
 * Strings for component 'filter_simplequestion', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['link_text'] = 'Hacer click para pregunta';
...
$string['questionidmismatch'] = 'Error de programación: Mala asociación de pregunta';
$string['settings_desc'] = 'Cambiar las configuraciones para este filtro. <br />
NOTA: Si Usted cambia las marcas (tags) de inicio y fin cualquier usuario existente fallará.
   ¡Configure ésto solamente cuando Usted habilita por primera vez el filtro!';
...
$string['settings_end_tag'] = 'Marca (tag) Final';
$string['settings_end_tag_desc'] = 'Marca (tag)  que marca el final de la pregunta';
...
$string['settings_start_tag'] = 'Marca (tag) de inicio';
$string['settings_start_tag_desc'] = 'Marca (tag) que marca el inicio de la pregunta';
