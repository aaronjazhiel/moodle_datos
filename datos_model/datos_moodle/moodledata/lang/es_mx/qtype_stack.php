...
/**
 * Strings for component 'qtype_stack', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   qtype_stack
...
when \\(P\\) and \\(Q\\) son polinomios con el grado de \\(P\\) menor que el grado de \\(Q\\). Con este caso,  nosotros procedemos como sigue:
...
el grado del numerador (i.e. \\(P(x)\\)) and \\(d\\) es el grado del denominados (por ejemplo \\(Q(x)\\)).
</li></ul>';
...
$string['ansnotemismatch'] = '[Discordancia en NotadeRespuesta]';
...
$string['ATAlgEquiv_SA_not_logic'] = 'Su respuesta debería de ser una ecuación, desigualdad, o una combinación lógica de varias de éstas, pero no lo es.';
...
$string['ATAlgEquiv_SA_not_string'] = 'Su respuesta debería ser una cadena de caracteres (string) pero no lo es.';
...
$string['ATEquivFirst_SA_not_list'] = 'El primer argumento a la prueba de respuesta Equiv debería de ser una lista, pero la prueba falló. Por favor contacte  a su profesor.';
...
$string['ATEquivFirst_SB_not_list'] = 'El segundo argumento de la prueba de respuesta Equiv debería de ser una lista, pero la prueba falló. Por favor contacte con su profesor.';
$string['ATEquiv_SA_not_list'] = 'El primer argumento de la prueba de respuesta Equiv debería de ser una lista, pero la prueba falló. Por favor contacte con su profesor.';
$string['ATEquiv_SB_not_list'] = 'El segundo argumento de la prueba de respuesta Equiv debería de ser una lista, pero la prueba falló. Por favor contacte con su profesor.';
...
$string['ATNum_OutofRange'] = 'Una expresión numérica está fuera del rango soportado. Por favor, contacte con su profesor.';
...
$string['ddl_runtime'] = 'El ingreso ha generado el siguiente error de corrida que le impide a Usted contestar. Por favor, contacte con su profesor.';
...
$string['deploymanynotes'] = 'Tome nota de que STACK se dará por vencido si hubiera 10 intentos fallidos para generar una nueva nota de pregunta, o cuando falle una prueba de pregunta.';
...
$string['equiv_ANDOR'] = 'y/o confusión !';
...
$string['expectedoutcomes'] = 'Resultados PTR (Potencial Response Tree = Árbol de Respuesta Potencial) esperados: [entradas usadas]';
...
$string['insertstarsyes'] = 'Insertar estrellas para multiplicación implícita solamente';
...
$string['numericalinputminmaxerr'] = '¡El número requerido de dígitos excede el número máximo de digitos!';
...
$string['prtnamelength'] = 'Los nombres PTR (Potencial Response Tree = Árbol de Respuesta Potencial) no pueden ser más largos de 18 caracteres. \'{$a}\' es demasiado largo.';
