...
/**
 * Strings for component 'hvp', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   hvp
...
$string['enabledownload'] = 'Botón de Descargar';
...
$string['installdenied'] = 'Usted no tien epermiso para instalar tipos de contenido. Contacte con el administrador de su sitio.';
...
$string['invalidtoken'] = 'Ficha (token) de seguridad inválida.';
...
$string['missinguploadpermissions'] = 'Tome nota de que pueden existir librerías en el paquete que Usted subió, pero Usted no tiene permitido subir nuevas librerías. Contacte con el administrador del sitio a este respecto.';
...
Las interacciones con el usuario y los puntajes son monitoreados usando xAPI y están disponibles mediante el Libro de Calificaciones de Moodle.

Usted añade contenido interactivo H5P al subir un archivo .h5p . Usted puede crear y descargar archivos .h5p en h5p.org';
...
$string['sitecouldnotberegistered'] = 'El sitio no pudo ser registrado con el hub. Por favor, contacte con el administrador del sitio.';
...
$string['upgradeinvalidtoken'] = 'Error: ¡ Ficha (token) de seguridad inválida !';
