...
/**
 * Strings for component 'tool_objectfs', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['object_status:never_run'] = 'El quehacer para generar este reporte no ha sido corrido.';
...
$string['pull_objects_from_storage_task'] = 'Quehacer para descargar objetos de sistema de archivo de objetos';
$string['push_objects_to_storage_task'] = 'Quehacer para subir objeto de sistema de archivo';
$string['recover_error_objects_task'] = 'Quehacer para recuperar error de objeto';
...
$string['settings:clientselection:title_help'] = 'El sistema de archivos de almacenamiento. Esto es también el sistema de archivo activo para los quehaceres en segundo plano.';
...
$string['settings:enabletasks'] = 'Habilitar quehaceres de transferencia';
$string['settings:enabletasks_help'] = 'Habilitar o deshabilitar los quehaceres de sistema de archivo de objeto que mueven archivos entre el directorio_de_archivos y el almacenamiento de objeto externo.';
...
$string['settings:maxtaskruntime_help'] = 'Quehaceres en segundo plano que manejan la transferencia de objetos desde y hacia el almacenamiento de objeto externo. Esta configuración controla el tiempo_de_corrida máximo para todos los quehaceres relacionados con transferencia de objetos.';
