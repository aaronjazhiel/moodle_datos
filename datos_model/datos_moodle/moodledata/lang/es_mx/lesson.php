...
/**
 * Strings for component 'lesson', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   lesson
...
$string['eventhighscoreadded'] = 'Puntaje alto añadido';
$string['eventhighscoresviewed'] = 'Puntajes altos vistos';
...
$string['mediafile_help'] = 'Puede subirse un archivo de medio para usarse en la lección. Se mostrará entonces un enlace para \'Haga click aquí para ver\' dentro de un bloque llamado \'Medio enlazado\' en cada página de la lección.';
