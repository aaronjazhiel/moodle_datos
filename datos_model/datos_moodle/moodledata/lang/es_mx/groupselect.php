...
/**
 * Strings for component 'groupselect', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   groupselect
...
$string['maxgroupmembership_error_low'] = 'Error: ¡Al menos 1 grupo necesita ser seleccionable!';
$string['maxlimitreached'] = 'Número máximo alcanzado';
$string['maxmembers'] = 'Miembros máx por grupo';
$string['maxmembers_error_low'] = 'Error: ¡Use 0 para indicar tamaño de grupo ilimitado!';
...
$string['minmembers_error_bigger_maxmembers'] = 'Error: ¡El tamaño mínimo del grupo necesita ser menor que el máximo de  participantes por grupo!';
$string['minmembers_error_low'] = 'Error: ¡No se permiten números negativos para el tamaño mínimo del grupo!';
...
$string['timeavailable_error_past_timedue'] = 'Error: ¡No puede iniciar después de la fecha esperada!';
$string['timedue'] = 'Abierto hasta antes de';
$string['timedue_error_pre_timeavailable'] = 'Error: ¡No puede terminar antes de la fecha de inicio!';
