...
/**
 * Strings for component 'filter_mathjaxloader', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['httpsurl'] = 'URL de MathJax por HTTPS';
$string['httpsurl_help'] = 'URL completa hacia librería (biblioteca) MathJax  cuando la página es cargada mediante https (seguro).';
$string['httpurl'] = 'URL de MathJax por HTTP';
$string['httpurl_help'] = 'URL completa hacia librería (biblioteca) MathJax  cuando la página es cargada mediante http.';
