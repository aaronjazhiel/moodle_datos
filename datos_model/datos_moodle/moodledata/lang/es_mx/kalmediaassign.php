...
/**
 * Strings for component 'kalmediaassign', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['addmedia'] = 'Añadir envío de medios';
$string['all'] = 'Todos';
...
$string['quickgrade_help'] = 'Si se habilita, se pueden calificar varias tareas en una sola página. Añada calificaciones y comentarios y después haga click en el botón para "Guardar mi retroalimentación" para guardar todos los cambios para esa pagina.';
$string['remainingtime'] = 'Tiempo restante';
$string['replacemedia'] = 'Remplazar medios';
...
$string['submitmedia'] = 'Enviar medios';
