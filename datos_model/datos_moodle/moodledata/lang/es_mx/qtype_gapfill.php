...
/**
 * Strings for component 'qtype_gapfill', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['correct'] = 'Retroalimentación para corregir.';
...
$string['example3'] = '¿De donde viene el canguro? [Australia]. El siguiente hueco aceptará igualment gato y perro [cat|dog]';
...
$string['itemsettings_button_help'] = 'Hacer click en este alternador para entrar a las configuraciones para-hueco, tales como retroalimentación para respuestas incorrectas. Haga click en una palabra hueco-limitada para que emerja un formato de configuraciones';
$string['itemsettingserror'] = 'Solemente funciona con el editor Atto. Vaya a Preferencias de editor  para cambiar a Atto';
...
$string['questiontext'] = 'Testo de la pregunta';
