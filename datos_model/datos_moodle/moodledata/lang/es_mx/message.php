...
/**
 * Strings for component 'message', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   message
...
$string['deletemessageconfirmation'] = '¿Está Usted seguro de querer eliminar este mensaje? Solamente será eliminado de su historia de mensajería y todavía será visible por el usuario que lo envió o recibió.';
...
$string['errorwhilesendingmessage'] = 'Ocurrió un error al enviar el mensaje; por favor, inténtelo nuevamente más tarde.';
...
$string['unabletomessageuser'] = 'Usted no tiene permitido enviarle un mensaje a ese usuario';
