...
/**
 * Strings for component 'tool_usersuspension', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
<p>Si Usted siente que esto es incorrecto, o si desea tener reactivada su cuenta nuevamente, por favor contacte con  {$a->contact}</p>
<p>Atentamente<br/>{$a->signature}</p>';
...
<p>Si Usted siente que esto no es lo que correspondía, o si quiere tener suspendida nuevamente su cuenta, por favor contacte con {$a->contact}</p>
<p>Atentamente<br/>{$a->signature}</p>';
...
Usando estas configuraciones, Usted puede automatizar la suspensión de usuarios al subir un archivo CSV a una localización aleatoria del servidor
