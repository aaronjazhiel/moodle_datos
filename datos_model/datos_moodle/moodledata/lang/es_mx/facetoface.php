...
$string['error:nopermissiontosignup'] = 'Usted no tiene permiso para registrarse en esta sesión cara-a-cara.';
...
$string['eventsignup'] = 'Registro a sesión';
$string['eventsignupfailed'] = 'Registro a sesión (FALLÓ)';
