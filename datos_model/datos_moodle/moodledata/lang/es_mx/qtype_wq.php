...
/**
 * Strings for component 'qtype_wq', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   qtype_wq
...
$string['addingwq'] = 'Añadiendo una pregunta de WIRIS genérico';
$string['cachedef_images'] = 'Imágenes de Exámenes WIRIS';
$string['cachedir'] = 'CACHE_DIR:';
$string['editingwq'] = 'Editando una pregunta de WIRIS genérico';
$string['error'] = 'ERROR';
$string['failedtoloadwirisquizzesfromxml'] = 'Falló al cargar definición XML de WIRIS quizzes para pregunta con ID';
...
$string['info_maintitle'] = 'Página de prueba de exámenes WIRIS Moodle 2.x';
...
$string['info_test2_info'] = 'Revisar plugin WIRIS';
$string['info_test2_infopage'] = 'página de información';
$string['info_test2_name'] = 'Versión de plugin WIRIS';
$string['info_test2_rt1'] = 'Plugin WIRIS está instalado apropiadamente';
$string['info_test2_rt2'] = 'Exámenes WIRIS requiere plugin WIRIS 3.17.20 o mayor. Su versión es';
$string['info_test2_rt3'] = 'Imposible encontrar archivo de versión de plugin WIRIS';
...
$string['info_test4_rt1'] = 'Los siguientes plugins de pregunta WIRIS están instalados:';
$string['info_test4_rt2'] = 'Los siguientes plugins de pregunta WIRIS están faltantes:';
$string['info_test4_rt3'] = 'Instalar';
$string['info_test5_name'] = 'Base de Datos';
$string['info_test5_rt1'] = 'Todas las tablas WIRIS están presentes.';
$string['info_test5_rt2'] = 'Falta una o más tablas WIRIS';
$string['info_test6_name'] = 'Exámenes WIRIS';
$string['info_test7_name'] = 'Revisando configuración de WIRIS';
$string['info_test8_name'] = 'Revisando si el servidor WIRIS está alcanzable';
$string['info_test8_rt1'] = 'Connectando a %s al puerto %s';
$string['info_test9_name'] = 'Servicio de preguntas WIRIS';
$string['ok'] = 'OK';
$string['pluginname'] = 'Matemáticas y Ciencia por WIRIS';
...
$string['wq'] = 'Matemáticas y Ciencia por WIRIS';
$string['wq_help'] = 'Ayuda genérica para exámenes WIRIS';
$string['wqsummary'] = 'Esto añade una pregunta genérica WIRIS. Solamente para fines de ensayo-prueba-experimento. Estará oculta aquí.';
