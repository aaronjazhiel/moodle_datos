...
/**
 * Strings for component 'reader', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   reader
...
$string['export_reader_tables_desc'] = 'Exportar tablas de base de datos de Reader. Tome nota de que los datos exportados no contienen nombres de usuario ni de curso, solamente IDs.';
...
$string['fix_installxml_desc'] = 'Hacer las marcas (tags) XML en db/install.xml compatibles con Moodle <= 2.5

* añadir atributos NEXT y PREVIOUS a las marcas (tags) TABLE, FIELD, KEY e INDEX
* añadir atributos SEQUENCE a marcas (tags) FIELD con TYPE="int"';
...
Tome nota de que si Usted elige "No", el conteo de palabras para cada estudiante en actividades Reader no será afectado por esta operación.
...
* eliminar preguntas Reader no usadas en ningun examen Reader
...
$string['fixquestiontext'] = 'Corregir marcas (tags) en preguntas de Lector';
...
También, por favor tome nota de que los estudiantes nunca pueden volver a tomar exámenes Reader, incluyendo aquellos tomados en períodos anteriores, a menos de que el profesor elimine el intento anterior.';
$string['image'] = 'Imagen';
...
$string['readonlymode_desc'] = 'Esta actividad actualmente está en modo de solo-lectura. Usted puede ver la información en la primera página de esta actividad Reader, pero actualmente Usted no puede tomar ningun examen Reader.';
...
$string['readonlyuntil_help'] = 'Antes de esta fecha y hora, los estudiantes pueden ver sus páginas principales de Reader, pero no pueden tomar ningun examen vía esta actividad reader.';
...
$string['run_readercron_desc'] = 'Correr el quehacer cron para el módulo Reader.';
...
$string['setgoals_description'] = 'En esta página Usted puede configurar las metas de lectura para estudiantes en niveles específicos de lectura, o en grupos específicos. Tome nota de que las configuraciones para estudiantes individuales en las páginas de reporte anularán las configuraciones de ésta página.';
$string['setlevel'] = 'Configurar nivel';
$string['setlevels'] = 'Configurar niveles';
$string['setlevels_description'] = 'En esta página Usted puede configurar los niveles de lectura para grupos de estudiantes.Tome nota de que estas configuraciones anularán las configuraciones para estudiantes individuales en las páginas de reportes.';
...
Tome nota de que si Usted elige "No", los conteos de palabras en las Actividades reader no serán afectados por esta operación.
