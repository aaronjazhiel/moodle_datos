...
/**
 * Strings for component 'block_credly', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['orgiddesc'] = 'Si Usted está gestionando y otorgando insignias a nombre de una organización, configure esto a la ID numérica de la cuenta de la organización en Credly. Usted puede encontrar esta información al acceder a la cuenta de la organización y hacer click en "View Profile". . Usted será llevado a una URL como por ejemplo http://credly.com/u/&lt;<i>numerical id</i>&gt; y Usted puede usar la ID mosntrada en la URL. NOTA: Si Usted está usando una organización, Usted tiene que asegurarse de que la cuenta que está usando para nombre_de_usuario/contraseña es, ya sea un propietario o un mánager de la organización.and you can use the id displayed in the url. NOTE: If you are using an organization, you have to make sure that the account you are using for username/password is either an owner or a manager of the organization.';
