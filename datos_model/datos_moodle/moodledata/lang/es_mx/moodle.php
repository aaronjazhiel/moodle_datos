...
/**
 * Strings for component 'moodle', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   moodle
...
$string['emailpasswordconfirmnoemail'] = '<p>La cuenta de usuario que Usted especificó no tiene grabada una dirección de Email.</p> <p>Por favor, contacte con el administrador.</p>';
$string['emailpasswordconfirmnotsent'] = '<p>El detalle del usuario que Usted proporcionó no identifica una cuenta de usuario existente.</p> <p>Por favor, revise la información que escribió, y vuelva a intentarlo. Si continúa teniendo dificultades, por favor contacte con el administrador del sitio.</p>';
...
$string['emailresetconfirmsent'] = 'Se ha enviado un Email a su dirección en <b>{$a}</b>. <br />Este Email contiene instrucciones sencillas para confirmar y completar este cambio de contraseña. Si Usted continúa experimentando dificultades, contacte con el administrador del sitio.';
...
$string['newsitemsnumber_help'] = 'Esta configuración determina cuantos items recientes aparecen en el bloque de últimos anuncios en la página del curso. Si se configura a cero, entonces el bloque de últimos anuncios no se mostrará.';
...
$string['setpasswordinstructions'] = 'Por favor escriba y repita debajo su nueva contraseña, después elija "Configurar contraseña". <br />Su nueva contraseña será guardada y Usted será ingresado.';
