...
/**
 * Strings for component 'mediasite', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   mediasite
...
$string['my_mediasite_placement_hint'] = '"Menú del Curso" añade este enlace a todos los cursos para usuaris inscritos. "Página Inicial del Sitio" es una localización más central.';
...
$string['notypes'] = 'Actualmente no hay herramientas LTI configuradas en Moodle. Haga click en el enlace de instalación superior para añadir algunas.';
...
$string['popupresourcelink'] = 'en caso contrario, hacer click aquí: {$a}';
