...
/**
 * Strings for component 'theme_essential', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['advert_tagline'] = 'Si Usted quiere aprender a personalizar temas, pero no posee formación previa en desarrollo, ni tiene experiencia con PHP y experiencia con Temas de Moodle, ¡ entonces  \'MoodleBites Theme Design Level 1\' es para Usted ! Le dará una amable introducción al  desarrollo de Temas de Moodle, y le proporcionará una buena preparación si desea progresar más adelante. Por favor haga click aquí para más información.';
...
$string['analyticsdesc'] = 'Elija el tipo de Analítica que desea insertar y guárdelo para habilitar las otras opciones.';
$string['analyticsenabled'] = 'Habilitado';
$string['analyticsenableddesc'] = 'Habilitar Analítica para Moodle';
$string['analyticsguniversal'] = 'Analítica Universal de Google';
$string['analyticsheadingsub'] = 'Analítica poderosa para Moodle';
...
$string['analyticssiteurl'] = 'URL de Analítica';
$string['analyticssiteurldesc'] = 'Escriba la URL de su "Piwik Analytics"  sin http(s) o una diagonal final. Por ejemplo  "misitio.com/analytics".';
...
<p>Essential está basado en el tema Bootstrap (Inicio) , que fuera creado para Moodle 2.5, con la ayuda de :<br>
...
El trabajo fue continuado a partir del 2014 por:<br>
Gareth J. Barnard<br>
David Bezemer<br>
</p>
<h3>Donativos</h3>
<p>Este tema se le proporciona a Usted gratuitamente, y si desea expresar su gratitud por usar este tema, considere por favor hacer un donativo por:
<h4>PayPal</h4>
<p>Por favor contácteme por medio de mi <a href="http://moodle.org/user/profile.php?id=442195" target="_blank">\'perfil en Moodle\'</a> para más detalles, debido a que soy un individuo y como tal no puedo tener botones para \'cómpreme ahora (buy me now)\' por los términos de uso.</p>
<h4>Flattr</h4>
<a href="https://flattr.com/profile/gjb2048" target="_blank">
haga click aquí para financiar.
</a>
<br>Los patrocinios ayudan para facilitar el mantenimiento y me permiten proporcionarle a Usted más y mejores caracterísrticas. Sin el soporte de Usted el tema no puede mantenerse.</p>
<p>
<h3>Patrocinadores</h3>
<p>Agradecemos su patrocionio a :</p>
<ul>
...
<p>
<h3>Essential para Moodle 3.0 amablemente patrocinado por:</h3>
<ul>
<li>Leila Hiret</li>
...
<p>Si a Usted le gusta este tema y quisiera que yo lo personalizara para Usted, que trasplante funcionalidad hacia otro tema, o que fabrique un tema nuevo desde cero, entonces yo le ofrezco precios competitivos. Por favor, contácteme via  \'http://moodle.org/user/profile.php?id=442195\'  para discutir sus necesidades.</p>
</div></div>';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'Por favor suba su logo personalizado aquí si desea añadirlo al encabezado.<br>La imagen debería de  ser del mismo alto y ancho que las configuraciones inferiores para \'Ancho del Logo\' y \'Altura del Logo\'.<br>Si Usted sube un logo, remplazará al ícono estándar y el nombre que se muestran por defecto.';
...
$string['logoheightdesc'] = 'La altura de la imagen del logo. Esto puede epecificarse en pixeles (px) o em (unidades tipográficas), como por ejemplo \'24px\'.';
$string['logowidth'] = 'Ancho del logo';
$string['logowidthdesc'] = 'El ancho de la imagen del logo. Esto puede epecificarse en pixeles (px) o em (unidades tipográficas), como por ejemplo, \'96px\'.';
