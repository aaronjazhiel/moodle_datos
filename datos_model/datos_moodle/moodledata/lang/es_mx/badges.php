...
/**
 * Strings for component 'badges', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   badges
...
$string['backpackconnectionunexpectedresult'] = 'Hubo un problema al contactar a la Mochila. Por favor, inténtelo nuevamente.<br><br>Si este problema persiste, por favor contacte con su administrador.';
...
Si Usted necesita ayuda, por favor contacte con el administrador del sitio,
{$a->admin}';
