...
/**
 * Strings for component 'qtype_ddimageortext', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['formerror_disallowedtags'] = 'Lo siento, las etiquetas (tags) HTML no están permitidas dentro del texto arrastrable.';
