...
/**
 * Strings for component 'mediagallery', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['caption_help'] = 'EL letrerito para este ítem en su galería. Este letrerito se mustrara junto al ítem.';
...
$string['deleteorremovecollection'] = 'Si Usted desea quitar el enlace a la colección sin eliminar el contenido haga click en enviar.<br/><br/>

Si Usted desea quitar el enlace a la colección y eliminar el contenido en su interior, escriba DELETE en el área_de_texto inferior y haga click en enviar. DELETE es ELIMINAR en idioma inglés.';
...
$string['deleteorremovegallery'] = 'Si Usted desea quitar el enlace a la galería sin eliminar el contenido haga click en enviar.<br/><br/>

Si Usted desea quitar el enlace a la galería y eliminar el contenido en su interior, escriba DELETE en el área_de_texto inferior y haga click en enviar. DELETE es ELIMINAR en idioma inglés.';
...
$string['deleteorremoveitem'] = 'Si Usted quiere quitar el ítem de la galería sin eliminar el contenido haga click en enviar.<br/><br/>

Si Usted quiere quitar el enlace hacia la galería y eliminar el tipo de contenido escriba DELETE -lo que inglés significa ELIMINAR- en la caja_de_texto inferior y haga click en enviar.';
...
$string['displayfullcaption'] = 'Mostrar testo completo de subtítulo';
...
$string['maxitems_help'] = 'El número máximo de ´tems que un usuario puede poner en una galería en esta colección.
