...
/**
 * Strings for component 'theme_training', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['configtitle'] = 'Entrenamiento (Training)';
...
$string['gridviewdesc'] = 'Mostrar lista de cursos en un estilo de mampostería. Cuando no se activa, el estilo por defecto es ancho completo, en donde la imagen destacada del curso está a la izquierda del resumen del curso. Tome nota de que esta opción no afecta a los listados de la <strong>Lista Combo</strong>';
