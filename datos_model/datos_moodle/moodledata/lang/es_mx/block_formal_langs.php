...
/**
 * Strings for component 'block_formal_langs', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['maximumvariationsoftypocorrectionsettingdescription'] = 'A veces, cuando un estudiante hace muchos errores tipográficos en la respuesta, el plugin puede generar muchas variaciones para corregirlos, lo que toma mucho tiempo para analizarlos. En esos casos, Usted debería diminuir esta configuración. Tome nota de que esto afecta la cantidad de errores tipográficos encontrados. Si Usted lo configura demasiado bajo, podría no encontrar algunos errores tipográficos.';
$string['maximumvariationsoftypocorrectionsettingname'] = 'Máxima cantidad de variaciones de corrección de error tipográfico een respuesta de estudiante';
