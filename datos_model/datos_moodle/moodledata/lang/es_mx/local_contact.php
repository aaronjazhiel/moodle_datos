...
/**
 * Strings for component 'local_contact', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
<ul>
<li>Asegurarse de que la marca (tag) {recaptcha} esté incluida en todos los formatos procesados por Formato de Contacto para Moodle.</li>
