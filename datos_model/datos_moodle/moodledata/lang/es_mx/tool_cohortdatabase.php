...
/**
 * Strings for component 'tool_cohortdatabase', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['cohortdatabase:config'] = 'Configurar instancias de base de datos';
...
$string['removedaction_desc'] = 'Seleccionar acción a realizar cuando el usuario desaparece de la fuente de cohorte externa. Por favor tome nota de que lgunos datos del usuario y configuraciones son purgadas del curso si éste fuera sincornizado con la des-inscripción del curso.';
