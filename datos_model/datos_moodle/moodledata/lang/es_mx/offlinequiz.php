...
/**
 * Strings for component 'offlinequiz', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   offlinequiz
...
$string['csvformat'] = 'Archivo de valores separados por coma (CSV)';
...
$string['invalidformula'] = 'Fórmula inválida para identificación del usuario. La fórmula debe de tener el fomato &lt;prefix&gt;[&lt;#digits&gt;]&lt;suffix&gt;=&lt;db-field&gt;.';
...
$string['modulename_help'] = 'Este módulo le permite al profesor diseñar exámenes fuera-de-línea consistentes en preguntas de opción múltiple.
Estas preguntas se guardan en el Banco de preguntas de Moodle y se pueden re-utilizar en cursos e inclusive entre cursos diferentes.
Los exámenes fuera-de-línea pueden descargarse como archivos PDF. Los estudiantes marcan sus respuestas en una hoja formato de respuestas. Las hojas formatos de respuestas son escaneadas y las respuestas son importadas dentro del sistema.';
...
Ene sta pestaña Usted puede subir la lista llenada de participantes. Usted puede subir imágenes únicas escaneadas o varias imágenes escaneadas metidas dentro de un archivo-ZIP.  El módulo de exámenes fuera-de-línea procesará en segundo plano los archivos de imágenes. Los nombres de los archivos no son relevantes  pero no deben de contener caracteres especiales como eñe ni vocales acentuadas. Las imágenes deben de ser GIFs, PNGs o TIFs. Se recomienda una resolución de entre 200 y 300 puntos por pulgada (dpi).</p>';
...
usepackage{amsmath} % para implies etc
...
$string['regradedisplayexplanation'] = '<b>Atención:</b> ¡Re-calificar no cambiará las puntuaciones que hayan sido anuladas manualmente!';
