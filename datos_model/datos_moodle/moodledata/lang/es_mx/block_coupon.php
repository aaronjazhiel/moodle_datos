...
/**
 * Strings for component 'block_coupon', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['error:cohort_sync'] = 'Ocurrió un error al tratar de sincronizar los cohortes. Por favor contacte con soporte.';
...
$string['error:course-coupons-not-copied'] = 'Ocurrió un error al tratar de copiar coupon-courses a la nueva tabla de coupon_courses. Por favor contacte con soporte.';
...
$string['error:missing_cohort'] = 'El/los cohorte(s) enlazado(s) a este cupón no existe(n) más. Por favor contacte con soporte.';
$string['error:missing_course'] = 'El curso enlazado a este cupón no existe más. Por favor contacte con soporte.';
$string['error:missing_group'] = 'El/los grupo(s) enlazado(s) a este cupón no existe(n) más. Por favor contacte con soporte.';
...
$string['error:plugin_disabled'] = 'El plugin cohort_sync ha sido deshabilitado. Por favor contacte con soporte.';
...
$string['error:unable_to_enrol'] = 'Ocurrió un eror al tratar de inscribirlo a Usted en elcurso nuevo. Por favor contacte con soporte.';
