...
/**
 * Strings for component 'studentquiz', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
 * @package   studentquiz
...
Su pregunta \'{$a->questionname}\' en el curso \'{$a->coursename}\' en actividad ExamenEstudiante (StudentQuiz) \'{$a->modulename}\' ha sido aprobada por \'{$a->actorname}\'
en \'{$a->timestamp}\'.
...
Su pregunta \'{$a->questionname}\' en el curso \'{$a->coursename}\' en actividad ExamenEstudiante (StudentQuiz) \'{$a->modulename}\' ha sido modificada por \'{$a->actorname}\'
en \'{$a->timestamp}\'.
...
Su pregunta \'{$a->questionname}\' en actividad ExamenEstudiante (StudentQuiz) \'{$a->modulename}\' en curso \'{$a->coursename}\' ha sido comentada por  \'{$a->actorname}\' en \'{$a->timestamp}\'.
...
El comentario en \'{$a->commenttime}\' asu pregunta \'{$a->questionname}\' en actividad ExamenEstudiante (StudentQuiz) \'{$a->modulename}\' en curso \'{$a->coursename}\' haa sido eliminado por \'{$a->actorname}\' en \'{$a->timestamp}\'.
...
Su comentario en \'{$a->commenttime}\' a la pregunta \'{$a->questionname}\' en la actividad ExamenEstudiante (StudentQuiz) \'{$a->modulename}\' en curso \'{$a->coursename}\' ha sido eliminado por \'{$a->actorname}\' en \'{$a->timestamp}\'.
...
La aprobación de su pregunta \'{$a->questionname}\' en la actividad ExamenEstudiante (StudentQuiz) \'{$a->modulename}\' en curso \'{$a->coursename}\' ha sido revocada por  \'{$a->actorname}\' en \'{$a->timestamp}\'.
...
$string['rankingsettingsdescription'] = 'Los valores que Usted configure aquí definen los valores de ranking por defecto que son usados en el formato para configuración cuando usted crea un nuevo ExamenEstudiante (StudentQuiz).';
...
$string['reportquiz_stats_all_questions_approved_help'] = 'Los profesores pueden aprobar las preguntas para verificar que estén correctas. Este es el número de todas las preguntas aprobadas dentro de este ExamenEstudiante (StudentQuiz).';
...
$string['reportquiz_stats_own_questions_approved_help'] = 'Los profesores pueden aprobar manualmente las preguntas para verificar que estén correctas. Este es el número de sus preguntas aprobados dentro de este ExamenEstudiante (StudentQuiz).';
$string['reportquiz_stats_own_questions_created'] = 'Número de preguntas que Usted ha contribuido';
$string['reportquiz_stats_own_questions_created_help'] = 'Número de preguntas que Usted ha contribuido a este ExamenEstudiante (StudentQuiz).';
...
$string['settings_allowedqtypes_help'] = 'Aquí Usted especifica el tipo de preguntas que están permitidas';
...
$string['settings_removeqbehavior_help'] = 'Esta información debería de aparecer solamente una vez durante la actualización. Nosotros le informamos que hemos detectado que su plugin de comportamiento de pregunta ExamenEstudiante (StudentQuiz) está instalado. Este plugin ya no es necesario más, por lo que trataremos de removerlo automáticamente. Si Usted todavía ve esta configuración, por favor desinstale manualmente el plugin de comportamiento de pregunta ExamenEstudiante (StudentQuiz) <a href="{$a}">aquí</a>.';
